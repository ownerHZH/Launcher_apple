...
//	}
	...
	protected void animateClickFeedback(View v, final Runnable r) {
		// animate the view slightly to show click feedback running some logic
		// after it is "pressed"
		ObjectAnimator anim = (ObjectAnimator) AnimatorInflater.loadAnimator(
				mContext , R.anim.paged_view_click_feedback);
		anim.setTarget(v);
	...
	protected void resetCheckedGrandchildren() {
		// loop through children, and set all of their children to _not_ be
		// checked
	...
	protected String getCurrentPageDescription() {
		...
		return String.format(
				getContext().getString(R.string.default_scroll_format), page + 1,
				getChildCount());
	}
