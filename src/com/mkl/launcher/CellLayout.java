...
public class CellLayout extends ViewGroup {
    ...
    static int widthInPortrait(Resources r, int numCells) {
        ...
        int width = minGap * (numCells - 1) + cellWidth * numCells;
        // convert from px to dp
        return (int)(width / r.getDisplayMetrics().density + 0.5f);
    }
    ...
    static int heightInLandscape(Resources r, int numCells) {
        ...
        int height = minGap * (numCells - 1) + cellHeight * numCells;
        // convert from px to dp
        return (int)(height / r.getDisplayMetrics().density + 0.5f);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBackgroundAlpha > 0.0f) {
            ...
            bg.setBounds(0,0,getWidth(),(int)getHeight()-114);
            bg.draw(canvas);
        }
        ...
        if (mCrosshairsVisibility > 0.0f) {
            ...
            for (int col = 0; col <= countX; col++) {
                ...
                for (int row = 0; row <= countY; row++) {
                    ...
                    if (alpha > 0.0f) {
                        d.setBounds(x, y-15, x + width, y + height-15);
        ...
        for (int i = 0; i < mDragOutlines.length; i++) {
            ...
            if (alpha > 0) {
                ...
                canvas.drawBitmap(b, p.x, p.y-15, paint);
            }
        }
