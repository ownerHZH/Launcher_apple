...
public class BubbleTextView extends TextView {
    ...
    // add by luoguoliang
    private Animation myAnimation_Romate = AnimationUtils.loadAnimation(getContext(),R.anim.scale); 
    private Animation myAnimation_Translate = AnimationUtils.loadAnimation(getContext(),R.anim.translate);
